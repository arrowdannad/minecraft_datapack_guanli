#修改区间
scoreboard players operation #hjrt_time_max hjrt_num = #hjrt_time_1 hjrt_num
...
#若差不为1，则继续猜
execute unless score #hjrt_time_dt hjrt_num matches 1 run function hjrt:string_cycle/false_0