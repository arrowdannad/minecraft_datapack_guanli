...
tellraw @a[scores={awd_mx-caidan=1,awd_mx-guanli=1..}] ["",{"text":"| ","color":"green"},{"text": "修改公告","color": "blue","clickEvent": {"action": "run_command","value": "/trigger awd_mx-gonggao set 2"}}]
...
scoreboard players enable @a awd_mx-caidan
scoreboard players enable @a awd_mx-caidan_mokuai
scoreboard players enable @a awd_mx-gonggao

execute at @a[scores={awd_mx-caidan=2}] run function awd_mx-fuzhuxitong:caidan/awd_mx-caidan_moshi
execute at @a[scores={awd_mx-caidan=3}] run function awd_mx-fuzhuxitong:caidan/awd_mx-caidan_guanliyuan
#事务钩子
give @a[scores={awd_mx-caidan=1}] snowball 1
scoreboard players set @a[scores={awd_mx-caidan=1}] awd_mx-caidan 0
schedule function awd_mx-fuzhuxitong:caidan/awd_mx-caidan 20t append